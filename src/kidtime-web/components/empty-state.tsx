  ...
  return (
    <Card>
      <CardContent className="flex min-h-80 flex-col items-center justify-center px-6 text-center">
        ...
        <p className="mt-1 mb-5 max-w-md text-sm text-muted-foreground">Download the Windows setup, copy the one-time code, and choose the child account in three guided steps.</p>
