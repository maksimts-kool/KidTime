...
import { AppWindow, BarChart3, Clock, Globe, LayoutDashboard, LogOut, MonitorCog, Settings, TriangleAlert } from "lucide-react";
...
const links = [
  ...
  { href: "/filtering", label: "Web filtering", icon: Globe },
